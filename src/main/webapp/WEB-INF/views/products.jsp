            ...
            <form action="/findProduct" method="post">
                <div class="form-group form-group-sm">
                    <div class="input-group input-group-sm">
                        <input type="search" class="form-control" name="pname" placeholder="输入商品名称..." value="${pname}"/>
...
<!-- 页面主体部分 -->
<div class="container">
    <c:if test="${pCount eq 0}"><h4 class="text-center text-info">没找到符合条件的商品</h4></c:if>
    <!-- 商品列表部分 -->
                ...
                <div class="img-thumbnail">
                    <div>
                        <a href="/findByProduct?id=${p.id}">
                            <img src="img/products/${p.url}" class="img-responsive img-rounded" style="width: 245px;height: 366px;"/>
                        </a>
                    </div>
                </div>
                <div class="title">
                    <a href="products.jsp">${p.name}</a>
                </div>
                <div class="price">
                    <span>￥</span>
                    <span>${p.price}</span>
